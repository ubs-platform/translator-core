...
__exportStar(__webpack_require__(/*! ./lib/translation-repository */ "./src/lib/translation-repository.ts"), exports);
__exportStar(__webpack_require__(/*! ./lib/model */ "./src/lib/model/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./lib/translation-lazyload-helper */ "./src/lib/translation-lazyload-helper.ts"), exports);


/***/ }),

/***/ "./src/lib/environment-controller.ts":
/*!*******************************************!*\
  !*** ./src/lib/environment-controller.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var EnvironmentController = /** @class */ (function () {
    function EnvironmentController(initialLanguage, useLocalStorage) {
        if (useLocalStorage === void 0) { useLocalStorage = true; }
        this.useLocalStorage = useLocalStorage;
        this._currentLanguageSubject = new rxjs_1.ReplaySubject(1);
        this._currentLanguage = '';
        this.LANGUAGE_KEY_LOCALSTORAGE = 'CURRENT_LANGUAGE';
        if (useLocalStorage &&
    ...
    EnvironmentController.prototype.getLanguage = function () {
        return this._currentLanguageSubject.asObservable();
    };
    EnvironmentController.prototype.languageAfterSet = function () {
        if (this.useLocalStorage) {
            localStorage.setItem(this.LANGUAGE_KEY_LOCALSTORAGE, this._currentLanguage);
        }
    };
    EnvironmentController.prototype.setLanguage = function (language) {
        this._currentLanguage = language;
        this._currentLanguageSubject.next(language);
        this.languageAfterSet();
    };
    EnvironmentController.getEnvironmentController = function (initialLanguageIfNotExist, useLocalStorageIfNotExist) {
        if (useLocalStorageIfNotExist === void 0) { useLocalStorageIfNotExist = true; }
        if (!this._mainBoss) {
            this._mainBoss = new EnvironmentController(initialLanguageIfNotExist, useLocalStorageIfNotExist);
        }
...
exports.__esModule = true;
__exportStar(__webpack_require__(/*! ./translation-collected-map */ "./src/lib/model/translation-collected-map.ts"), exports);
__exportStar(__webpack_require__(/*! ./translation-event */ "./src/lib/model/translation-event.ts"), exports);
__exportStar(__webpack_require__(/*! ./translation-parameter */ "./src/lib/model/translation-parameter.ts"), exports);
__exportStar(__webpack_require__(/*! ./translation-part */ "./src/lib/model/translation-part.ts"), exports);
__exportStar(__webpack_require__(/*! ./translator-text */ "./src/lib/model/translator-text.ts"), exports);


/***/ }),

/***/ "./src/lib/model/translation-collected-map.ts":
/*!****************************************************!*\
  !*** ./src/lib/model/translation-collected-map.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/lib/model/translation-event.ts":
/*!********************************************!*\
  !*** ./src/lib/model/translation-event.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/lib/model/translation-parameter.ts":
/*!************************************************!*\
  !*** ./src/lib/model/translation-parameter.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/lib/model/translation-part.ts":
/*!*******************************************!*\
  !*** ./src/lib/model/translation-part.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/lib/model/translator-text.ts":
/*!******************************************!*\
  !*** ./src/lib/model/translator-text.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/lib/translation-lazyload-helper.ts":
/*!************************************************!*\
  !*** ./src/lib/translation-lazyload-helper.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.__esModule = true;
exports.TranslationLazyloadHelper = exports.AsyncActionLazyloadHandler = exports.RxActionLazyloadHandler = exports.LinearActionLazyloadHandler = void 0;
var rxjs_1 = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/cjs/index.js");
var LinearActionLazyloadHandler = /** @class */ (function () {
    function LinearActionLazyloadHandler(fetchObjects) {
        this.fetchObjects = fetchObjects;
    }
    return LinearActionLazyloadHandler;
}());
exports.LinearActionLazyloadHandler = LinearActionLazyloadHandler;
var RxActionLazyloadHandler = /** @class */ (function () {
    function RxActionLazyloadHandler(fetchObjects) {
        this.fetchObjects = fetchObjects;
    }
    return RxActionLazyloadHandler;
}());
exports.RxActionLazyloadHandler = RxActionLazyloadHandler;
var AsyncActionLazyloadHandler = /** @class */ (function () {
    function AsyncActionLazyloadHandler(fetchObjects) {
        this.fetchObjects = fetchObjects;
    }
    return AsyncActionLazyloadHandler;
}());
exports.AsyncActionLazyloadHandler = AsyncActionLazyloadHandler;
var TranslationLazyloadHelper = /** @class */ (function () {
    function TranslationLazyloadHelper() {
        this._lazyloaders = [];
        this._updated = new rxjs_1.Subject();
    }
    TranslationLazyloadHelper.prototype.getOnUpdated = function () {
        return this._updated.asObservable();
    };
    TranslationLazyloadHelper.prototype.insert = function () {
        var _this = this;
        var llhs = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            llhs[_i] = arguments[_i];
        }
        var ids = llhs.map(function (llh) {
            return _this._lazyloaders.push(llh);
        });
        this._updated.next(this._lazyloaders);
        return ids;
    };
    TranslationLazyloadHelper.prototype.remove = function (id) {
        this._lazyloaders.splice(id, 1);
    };
    TranslationLazyloadHelper.prototype.getList = function () {
        return this._lazyloaders;
    };
    return TranslationLazyloadHelper;
}());
exports.TranslationLazyloadHelper = TranslationLazyloadHelper;


/***/ }),

/***/ "./src/lib/translation-repository.ts":
/*!*******************************************!*\
  !*** ./src/lib/translation-repository.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var rxjs_1 = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/cjs/index.js");
var environment_controller_1 = __webpack_require__(/*! ./environment-controller */ "./src/lib/environment-controller.ts");
var translation_lazyload_helper_1 = __webpack_require__(/*! ./translation-lazyload-helper */ "./src/lib/translation-lazyload-helper.ts");
var TranslationRepository = /** @class */ (function () {
    function TranslationRepository(_lazyloadHelper) {
        if (_lazyloadHelper === void 0) { _lazyloadHelper = new translation_lazyload_helper_1.TranslationLazyloadHelper(); }
        var _this = this;
        this._lazyloadHelper = _lazyloadHelper;
        this._collected = {};
        this._changeDetected = new rxjs_1.Subject();
        environment_controller_1.EnvironmentController.getEnvironmentController()
            .getLanguage()
            .subscribe(function (a) {
            _this.setLanguage(a);
            _this._lazyloadHelper.getOnUpdated().subscribe(function () {
                _this.tryToGetNeededThings();
            });
        });
    }
    TranslationRepository.prototype.getLazyloadHelper = function () {
        return this._lazyloadHelper;
    };
    TranslationRepository.prototype.hasLanguage = function (lang) {
        return this._collected[lang] != null;
    };
    TranslationRepository.prototype.getCurrentLanguage = function () {
        return this._currentLanguage;
    };
    TranslationRepository.prototype.changeDetection = function () {
        return this._changeDetected.asObservable();
    };
    TranslationRepository.prototype.languageAfterSet = function () {
        this._changeDetected.next('LANGUAGE_CHANGE');
        this.tryToGetNeededThings();
    };
    TranslationRepository.prototype.tryToGetNeededThings = function () {
        return __awaiter(this, void 0, void 0, function () {
            var lists;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this._currentLanguage) return [3 /*break*/, 2];
                        lists = this._lazyloadHelper.getList();
                        return [4 /*yield*/, lists.forEach(function (a) { return __awaiter(_this, void 0, void 0, function () {
                                var object, _a;
                                var _this = this;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            object = a.fetchObjects(this._currentLanguage);
                                            if (!(object instanceof Promise)) return [3 /*break*/, 2];
                                            _a = this.registerParts;
                                            return [4 /*yield*/, object];
                                        case 1:
                                            _a.apply(this, [_b.sent(), this._currentLanguage]);
                                            return [3 /*break*/, 3];
                                        case 2:
                                            if (object instanceof rxjs_1.Observable) {
                                                object.subscribe(function (incomingObj) {
                                                    _this.registerParts(incomingObj, _this._currentLanguage);
                                                });
                                            }
                                            else {
    ...
    TranslationRepository.prototype.setLanguage = function (language) {
        console.debug("TRANSLATOR: Language changed to ".concat(language));
        this._currentLanguage = language;
        this.languageAfterSet();
        this.tryToGetNeededThings();
    };
    TranslationRepository.prototype.registerParts = function (part, lang) {
    ...
    TranslationRepository.prototype._registerParts = function (parts, language) {
        var _this = this;
        parts.forEach(function (a) { return _this._registerPart(a, language, false); });
        this._changeDetected.next('PART_REGISTERED');
    };
    TranslationRepository.prototype._registerPart = function (part, language, emit) {
        ...
        Object.entries(part.stringMap).forEach(function (_a) {
            var key = _a[0], value = _a[1];
            var keyPrefixed = [part.prefix, key].filter(function (a) { return a; }).join('.');
            collection[keyPrefixed] = value;
        });
        if (emit)
            this._changeDetected.next('PART_REGISTERED');
    };
    TranslationRepository.prototype.getString = function (translatorText) {
        var _a;
        var parameters, key;
        ...
        if (this._currentLanguage) {
            var languagePool = this._collected[this._currentLanguage];
            if (languagePool) {
                var text_1 = (languagePool === null || languagePool === void 0 ? void 0 : languagePool[key]) || '';
                (_a = Object.entries(parameters)) === null || _a === void 0 ? void 0 : _a.forEach(function (_a) {
                    var key = _a[0], value = _a[1];
                    var keyNeutralized = "{".concat(key, "}");
                    text_1 = text_1.split(keyNeutralized).join(value);
                });
                return text_1 || key;
            }
        }
    ...
    TranslationRepository.prototype.getStringListenChanges = function (translatorText) {
        var _this = this;
        return (0, rxjs_1.merge)((0, rxjs_1.of)(this.getString(translatorText)), this._changeDetected.pipe(
        // filter((a) => a == 'PART_REGISTERED'),
        (0, rxjs_1.map)(function (a) {
            console.debug("TRANSLATOR ".concat(a));
            return _this.getString(translatorText);
        })));
    };
